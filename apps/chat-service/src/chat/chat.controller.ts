...
export class ChatController {
  ...
  async getChatMessages(
    ...
    try {
      ...
      this.logger.error(
        `Get chat messages error: ${error.message}`,
        error.stack,
      );
      throw error;
    }
  ...
  async markAllMessagesAsRead(
    ...
    try {
      ...
      this.logger.error(
        `Mark all messages as read error: ${error.message}`,
        error.stack,
      );
      throw error;
    }
  ...
  async handleCreateChat(
    @Payload() data: { createChatDto: CreateChatDto; userId: string },
  ) {
  ...
  async handleSendMessage(
    @Payload() data: { sendMessageDto: SendMessageDto; userId: string },
  ) {
  ...
  async handleMarkMessagesRead(
    @Payload() data: { chatId: string; userId: string; messageIds?: string[] },
  ) {
